...
public class MainGps extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, ResultCallback<LocationSettingsResult>, LocationListener {
    ...
    private void updateLocationUI() {
        if (mCurrentLocation != null) {
            ...
            Log.wtf("latitude", "=> " + mCurrentLocation.getLatitude());
            Log.wtf("longitude", "=> " + mCurrentLocation.getLongitude());
        }
    }
    ...
    public void onResult(LocationSettingsResult locationSettingsResult) {
        ...
        switch (status.getStatusCode()) {
            ...
            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                try {
                    status.startResolutionForResult(MainGps.this, REQUEST_CHECK_SETTINGS);
                } catch (IntentSender.SendIntentException e) {
                    Log.wtf("SendIntentException", "=> " + e.getMessage());
                }
                break;
            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                Toast.makeText(getApplicationContext(), "Sorry", Toast.LENGTH_SHORT).show();
                Log.wtf("SETTINGS_CHANGE_UNAVAILABLE", "");
                break;
        }
    }
